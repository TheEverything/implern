...
interface Props {
  ...
  id: Id<"Catagory">;
  catagorTitle: string;
  linkCatagoryI: string;
  icon: string;
}

function CatagoryItem({ className, id, catagorTitle, linkCatagoryI, icon }: Props) {
  ...
  return (
    <div className="w-[428px] h-fit flex flex-col justify-start items-start gap-2.5 p-1.5 rounded-lg overflow-visible border border-[#E7E5E4]">
      <div onClick={() => router.push("/linkCategorl")} className="h-fit w-full flex flex-row justify-start items-start gap-1.5 p-2 opacity-100">
